(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(
  ...
  (t, r, e) => {
    var n = {
      675: function (t, r) {
        ...
        r.toByteArray = function (t) {
          ...
          h = 0,
          c = u > 0 ? f - 4 : f;
          for (e = 0; e < c; e += 4) r = n[t.charCodeAt(e)] << 18 | n[t.charCodeAt(e + 1)] << 12 | n[t.charCodeAt(e + 2)] << 6 | n[t.charCodeAt(e + 3)],
          a[h++] = r >> 16 & 255,
          a[h++] = r >> 8 & 255,
          a[h++] = 255 & r;
          return 2 === u &&
          (r = n[t.charCodeAt(e)] << 2 | n[t.charCodeAt(e + 1)] >> 4, a[h++] = 255 & r),
          1 === u &&
          (
            r = n[t.charCodeAt(e)] << 10 | n[t.charCodeAt(e + 1)] << 4 | n[t.charCodeAt(e + 2)] >> 2,
            a[h++] = r >> 8 & 255,
            a[h++] = 255 & r
          ),
          a
        ...
        r.fromByteArray = function (t) {
          for (var r, n = t.length, o = n % 3, i = [], f = 0, u = n - o; f < u; f += 16383) i.push(
            function (t, r, n) {
              for (var o, i = [], f = r; f < n; f += 3) o = (t[f] << 16 & 16711680) + (t[f + 1] << 8 & 65280) + (255 & t[f + 2]),
              i.push(e[o >> 18 & 63] + e[o >> 12 & 63] + e[o >> 6 & 63] + e[63 & o]);
              return i.join('')
            }(t, f, f + 16383 > u ? u : f + 16383)
          );
          return 1 === o ? i.push(e[(r = t[n - 1]) >> 2] + e[r << 4 & 63] + '==') : 2 === o &&
          i.push(e[(r = (t[n - 2] << 8) + t[n - 1]) >> 10] + e[r >> 4 & 63] + e[r << 2 & 63] + '='),
          i.join('')
        };
        for (
          var e = [],
      ...
      72: function (t, r, e) {
        ...
        'function' == typeof Symbol.for ? Symbol.for('nodejs.util.inspect.custom') : null;
        function f(t) {
        ...
        function u(t, r, e) {
          if ('number' == typeof t) {
            if ('string' == typeof r) throw TypeError(
        ...
        function s(t, r, e) {
          ...
          if (
            ...
            return Object.setPrototypeOf(
              n = void 0 === r &&
              void 0 === e ? new Uint8Array(t) : void 0 === e ? new Uint8Array(t, r) : new Uint8Array(t, r, e),
              u.prototype
            ),
            n
          }(t, r, e);
          if ('number' == typeof t) throw TypeError(
          ...
          var y = function (t) {
            ...
            return void 0 !== t.length ? 'number' != typeof t.length ||
            function (t) {
              return t != t
            }(t.length) ? f(0) : c(t) : 'Buffer' === t.type &&
            Array.isArray(t.data) ? c(t.data) : void 0
          }(t);
          if (y) return y;
          if (
        ...
        function p(t) {
          if (t >= 2147483647) throw RangeError(
        ...
        function l(t, r) {
          ...
          if ('string' != typeof t) throw TypeError(
        ...
        function y(t, r, e) {
          ...
          for (t || (t = 'utf8'); ; ) switch (t) {
            ...
            case 'base64':
              ...
              f = e,
              0 === i &&
              f === o.length ? n.fromByteArray(o) : n.fromByteArray(o.slice(i, f));
            case 'ucs2':
            case 'ucs-2':
            case 'utf16le':
            case 'utf-16le':
        ...
        function d(t, r, e, n, o) {
          ...
          if (
            'string' == typeof e ? (n = e, e = 0) : e > 2147483647 ? e = 2147483647 : e < - 2147483648 &&
            (e = - 2147483648),
            (i = e *= 1) != i &&
            (e = o ? 0 : t.length - 1),
            e < 0 &&
           ...
           else if (e < 0) if (!o) return - 1;
           else e = 0;
          if ('string' == typeof r && (r = u.from(r, n)), u.isBuffer(r)) return 0 === r.length ? - 1 : v(t, r, e, n, o);
          if ('number' == typeof r) {
            if (r &= 255, 'function' == typeof Uint8Array.prototype.indexOf) if (o) return Uint8Array.prototype.indexOf.call(t, r, e);
        ...
        function v(t, r, e, n, o) {
          ...
          if (o) {
            var h = - 1;
            for (i = e; i < u; i++) if (a(t, i) === a(r, - 1 === h ? 0 : i - h)) {
              if ( - 1 === h && (h = i), i - h + 1 === s) return h * f
            } else - 1 !== h &&
            (i -= i - h),
            h = - 1
          } else for (e + s > u && (e = u - s), i = e; i >= 0; i--) {
            for (var c = !0, p = 0; p < s; p++) if (a(t, i + p) !== a(r, p)) {
              c = !1;
              break
            }
            if (c) return i
        ...
        u.compare = function (t, r) {
          if (
            ...
            O(r, Uint8Array) &&
            (r = u.from(r, r.offset, r.byteLength)),
            !u.isBuffer(t) ||
            !u.isBuffer(r)
          ) throw TypeError(
        ...
        u.prototype.swap32 = function () {
          ...
          for (var r = 0; r < t; r += 4) g(this, r, r + 3),
          g(this, r + 1, r + 2);
          return this
        },
        u.prototype.swap64 = function () {
          ...
          for (var r = 0; r < t; r += 8) g(this, r, r + 7),
          g(this, r + 1, r + 6),
          g(this, r + 2, r + 5),
          g(this, r + 3, r + 4);
          return this
        ...
        function b(t, r, e) {
          ...
          for (var y = '', g = 0; g < l; ) y += String.fromCharCode.apply(String, p.slice(g, g += 4096));
          return y
        }
        function w(t, r, e) {
        ...
        function A(t, r, e, n, i) {
          ...
          e >>>= 0,
          i ||
          E(t, r, e, 4, 3.4028234663852886e+38, - 3.4028234663852886e+38),
        ...
        function B(t, r, e, n, i) {
          ...
          e >>>= 0,
          i ||
          E(t, r, e, 8, 1.7976931348623157e+308, - 1.7976931348623157e+308),
        ...
        u.prototype.write = function (t, r, e, n) {
          ...
          for (var l = !1; ; ) switch (n) {
            ...
            case 'utf-16le':
              ...
              I(
                function (t, r) {
                  for (var e, n, o = [], i = 0; i < t.length && !((r -= 2) < 0); ++i) n = (e = t.charCodeAt(i)) >> 8,
                  o.push(e % 256),
                  o.push(n);
                  return o
                }(t, this.length - h),
        ...
        u.prototype.writeIntLE = function (t, r, e, n) {
          ...
          f = 1,
          u = 0;
          for (this[r] = 255 & t; ++i < e && (f *= 256); ) t < 0 &&
          0 === u &&
          0 !== this[r + i - 1] &&
          (u = 1),
        ...
        u.prototype.writeIntBE = function (t, r, e, n) {
          ...
          f = 1,
          u = 0;
          for (this[r + i] = 255 & t; --i >= 0 && (f *= 256); ) t < 0 &&
          0 === u &&
          0 !== this[r + i + 1] &&
          (u = 1),
          this[r + i] = (t / f | 0) - u & 255;
        ...
        u.prototype.writeInt32LE = function (t, r, e) {
          ...
          r >>>= 0,
          e ||
          m(this, t, r, 4, 2147483647, - 2147483648),
          this[r] = 255 & t,
          this[r + 1] = t >>> 8,
          this[r + 2] = t >>> 16,
          this[r + 3] = t >>> 24,
        ...
        u.prototype.fill = function (t, r, e, n) {
          if ('string' == typeof t) {
            if (
              'string' == typeof r ? (n = r, r = 0, e = this.length) : 'string' == typeof e &&
              (n = e, e = this.length),
              void 0 !== n &&
              'string' != typeof n
          ...
          } else 'number' == typeof t ? t &= 255 : 'boolean' == typeof t &&
          (t = Number(t));
        ...
        var C = function () {
          for (var t = '0123456789abcdef', r = Array(256), e = 0; e < 16; ++e) for (var n = 16 * e, o = 0; o < 16; ++o) r[n + o] = t[e] + t[o];
          return r
        }()
      },
      783: function (t, r) {
        r.read = function (t, r, e, n, o) {
          ...
          p = e ? - 1 : 1,
          l = t[r + c];
          for (c += p, i = l & (1 << - h) - 1, l >>= - h, h += u; h > 0; i = 256 * i + t[r + c], c += p, h -= 8);
          for (f = i & (1 << - h) - 1, i >>= - h, h += n; h > 0; f = 256 * f + t[r + c], c += p, h -= 8);
          if (0 === i) i = 1 - a;
           else {
        ...
        r.write = function (t, r, e, n, o, i) {
          ...
          for (
            ...
            r === 1 / 0 ? (u = + !!isNaN(r), f = h) : (
              ...
              r * s >= 2 &&
              (f++, s /= 2),
              f + c >= h ? (u = 0, f = h) : f + c >= 1 ? (u = (r * s - 1) * Math.pow(2, o), f += c) : (u = r * Math.pow(2, c - 1) * Math.pow(2, o), f = 0)
            );
            o >= 8;
            t[e + l] = 255 & u,
            l += y,
    ...
    i.ab = '/ROOT/node_modules/.pnpm/next@16.0.7_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/buffer/',
    r.exports = i(72)
  },
  95161,
  t => {
    'use strict';
    var r = t.i(26581);
    let e = '-,pTU6sdpB>K>5)jamIhx3!_m|G7!/E]H#S$jn#s3Oqw#4J4F,OECU&480rg[o_(1?Vjmj}l2Lg515%x(qgmMy';
    async function n() {
      let t = new TextEncoder,
      r = await crypto.subtle.importKey('raw', t.encode(e), {
        name: 'PBKDF2'
      }, !1, [
        'deriveBits'
      ]),
      ...
      return crypto.subtle.importKey('raw', n, 'AES-GCM', !1, [
        'decrypt'
      ])
    }
    async function o(t) {
    ...
    async function i(t) {
      try {
        let e = t.split(':');
        if (3 !== e.length) throw Error(
          'Invalid encrypted data format (expected 3 parts separated by colon)'
        );
        let[o,
        i,
        f] = e;
        if (
          ...
          !/^[0-9a-f]*$/i.test(i) ||
          !/^[0-9a-f]*$/i.test(f)
        ) throw Error('Invalid hex encoding in encrypted data');
        let u = new Uint8Array(r.Buffer.from(o, 'hex')),
        s = new Uint8Array(r.Buffer.from(i, 'hex')),
        a = new Uint8Array(r.Buffer.from(f, 'hex'));
        if (16 !== u.length) throw Error(`Invalid IV length: expected 16 bytes, got ${ u.length }`);
        if (16 !== s.length) throw Error(
          `Invalid auth tag length: expected 16 bytes, got ${ s.length }`
        );
        let h = await n(),
        c = new Uint8Array(a.length + s.length);
        c.set(a),
        c.set(s, a.length);
        let p = await crypto.subtle.decrypt({
          name: 'AES-GCM',
          iv: u
        }, h, c),
        ...
        throw console.error('[v0] Decryption failed:', t),
        Error(`Failed to decrypt API response: ${ t }`)
      }
    }
    t.s(
      ['decryptApiResponse',
      () => i,
      'generateSecureRequestSignature',
      () => o]
    )
  }
  ]
